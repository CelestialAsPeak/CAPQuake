...
**CAPQuake** 是一款基于 Python + Pygame + ObsPy 构建的专业级地震预警桌面应用程序。它从全球二十余个公开数据源实时接收地震信息和紧急地震速报，提供交互式地图、自动视野跟随、波形显示、烈度速报图层等专业功能，并计划扩展气象、海啸、火山等模块，成为多灾种综合态势平台。
...
- 作者邮箱：celestialaspeak@outlook.com
