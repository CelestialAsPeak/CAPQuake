...
***此项目在快速迭代 功能在不断增加 预计后续内测后会完整开源***

***开发进展:CAPQuake Qt 0.5已完成80%的迁移工作 并且现已支持全球测站 共计42个信道的测站实时显示 @苏combo***

![Preview](682c06246fb53115bdd825a253892c79.png)
...
**CAPQuake** 是一款基于 Python + Pygame + ObsPy (后续会换成pyside前端)构建的专业级地震及其他灾情预警桌面应用程序。它从全球三十余个公开数据源实时接收地震信息和紧急地震速报，并包含气象、海啸、火山等预警模块，实现全球灾讯整合。
...
![Preview](d57dc1543c70766c5c46fde5d76a7199.png)
